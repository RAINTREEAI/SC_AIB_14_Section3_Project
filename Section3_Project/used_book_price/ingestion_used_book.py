...
def getSearchBook(keyword):
    ...
    # output : json
    # OptResult : 해당 상품에 등록된 중고상품 정보
    url = f"http://www.aladin.co.kr/ttb/api/ItemSearch.aspx?ttbkey={TTBKey}Query={keyword}&QueryType=Keyword&SearchTarget=Book" \
    ...
    for item in items:
        ...
        book_dict['adult'] = 1 if item['adult'] == 'true' else 0
